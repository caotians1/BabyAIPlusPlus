...
# Get the nubmer of descriptive sentences
n_floor_colors = envs[0].n_floor_colors
...
model_name_parts = {
    ...
    'coef': '',
    'suffix': suffix}
default_model_name = "{env}_{algo}_{arch}_{instr}_{texts}_{rand}_{mem}_seed{seed}{info}{coef}_{suffix}".format(**model_name_parts)
    ...
    if status['i'] % args.log_interval == 0:
        ...
        data = [status['i'], status['num_episodes'], status['num_frames'],
                ...
                *return_per_episode.values(),
                ...
                success_per_episode['std'] / np.sqrt(len(logs["return_per_episode"])),
                *num_frames_per_episode.values(),
                logs["entropy"], logs["value"], logs["policy_loss"], logs["value_loss"],
                logs["loss"], logs["grad_norm"]]

        format_str = ("U {} | E {} | F {:06} | FPS {:04.0f} | D {} | R:xsmM {: .2f} {: .2f} {: .2f} {: .2f} | "
                      "S:xs {:.2f} {:.4f} | F:xsmM {:.1f} {:.1f} {} {} | H {:.3f} | V {:.3f} | "
