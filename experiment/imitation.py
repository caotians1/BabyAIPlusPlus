        ...
        if self.acmodel is None:
            if getattr(self.args, 'pretrained_model', None):
                ...
                self.acmodel = ACModel(self.obss_preprocessor.obs_space, action_space,
                                       ...
                                       not self.args.no_desc, self.args.instr_arch,
                                       not self.args.no_mem, self.args.arch,
                                       random_shuffled=self.args.random_shuffle, instr_sents=self.env.n_floor_colors,
                                       enable_instr=self.args.enable_instr, instr_only=self.args.instr_only)
